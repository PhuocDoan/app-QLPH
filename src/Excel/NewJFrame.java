...
public class NewJFrame extends javax.swing.JFrame {
    ...
    Library<Phong_hoc> libs = new Library<Phong_hoc>();
    String fname = "";
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {                                         
       ...
       try{
        ...
        libs = ReadExcelDemo.getCell(fname);
        Status.setForeground(new java.awt.Color(51, 204, 0));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException, SQLException {                                         
    	...
    	if(fname != "") {
    		int check;
    		for(Phong_hoc tmp: libs.arr) {
    			check = DataBaseConect.conect(tmp.Room, tmp.Class, tmp.State, tmp.Detail);
    			if(check == 0) {
    				Status.setForeground(new java.awt.Color(255, 0, 0));
